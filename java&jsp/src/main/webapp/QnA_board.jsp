...
<head>
    ...
    <script>
        ...
        function search() {
            ...
            for (let i = 1; i <= 10; i++) {
                ...
                html += '<td></td>';
                html += '<td>'
                html += '<a href="QnA_detail.html" class="table_a">';
                html += title;
                html += '</a>';
                html += '</td>';
                html += '<td></td>';
    ...
    <style>
        ...
        /* 글씨체 변경 */
        .paging_writing .writing .change_handwriting,
        .board_notice .search .change_handwriting,
        ...
        /* 검색, 글쓰기 버튼 마우스 오버 */
        .paging_writing .writing .request:hover,
        .board_notice .search .request:hover {
                ...
                <div class="board_notice">
                    ...
                    <div class="board">
                        <div id="select">
                            ...
                            <input type="text" class="change_handwriting search_input" id="searchbox">
                            <input type="button" class="change_handwriting request search_button" value="검색"
                                onclick="search_box()">
                        </div>
                        <table class="board_sub">
                            <tr>
                                ...
                                <th class="board_subject">관할도서관</th>
                    ...
                    <div class="paging_writing">
                        ...
                        <div class="writing">
                            <button class="change_handwriting request"
                                onclick="location.href='QnA_write.html';">글쓰기</button>
