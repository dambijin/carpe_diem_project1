...
//             document.getElementsByName("email")[0].checked = true;
            ...
            mod.addEventListener("click", function () {
                ...
                if (password == "") {
                ...
                } else if (document.querySelector("#sample6_postcode").value == "") {
                    alert("우편번호 입력")
                    document.querySelector("#sample6_postcode").focus();

                } else if (document.querySelector("#sample6_address").value == "") {
                    alert("주소 입력")
                    document.querySelector("#sample6_address").focus();

                } else if (document.querySelector("#sample6_address2").value == "") {
                    alert("상세 주소 입력")
                    ...
                    if (password === password1) {
                        alert(name.textContent + "님의 정보를 수정하였습니다." + "\n" +
                            "비밀번호 : " + password + "\n" +
                            "휴대폰 번호 : " + phonenumber + "\n" +
                            "이메일 : " + document.querySelector("#email_id").value + "@" + email2.value + "\n" +
                            "sms수신동의여부 : " + selectSms + "\n" +
